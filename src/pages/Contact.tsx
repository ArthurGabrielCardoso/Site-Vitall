            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="animate-fade-in [animation-delay:100ms]">
                ...
                <div className="glass-card p-6 space-y-6 mb-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">(11) 93455-0921</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">contato@vitallcheckup.com.br</p>
                    </div>
                  </div>
                ...
                <div className="aspect-video rounded-xl overflow-hidden">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.2468741234567!2d-46.18765678901234!3d-23.52345678901234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce63bf5678901a%3A0x123456789abcdef0!2sMogi%20das%20Cruzes%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1628613152777!5m2!1spt-BR!2sbr"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
